...
$assert( 3 === $count, 'Analytics module should register menu, assets, and export hooks.' );
...
sort( $hooks );
$expected = array( 'admin_enqueue_scripts', 'admin_menu', 'admin_post_smtp_export_analytics' );
sort( $expected );
