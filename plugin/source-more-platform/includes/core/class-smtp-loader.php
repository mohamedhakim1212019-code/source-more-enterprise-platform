...
final class SMTP_Loader {
	...
	public static function load_runtime_classes(): void {
		...
		$files = array(
			'includes/core/class-smtp-container.php',
			'includes/core/class-smtp-capabilities.php',
			'includes/core/class-smtp-audit-log.php',
			'includes/core/class-smtp-core.php',
