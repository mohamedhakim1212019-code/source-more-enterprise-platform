...
<section class="section calculator-next-step">
  <div class="container section-heading"><div><span class="section-kicker"><?php echo esc_html(smt_t('What happens next','الخطوة التالية')); ?></span><h2><?php echo esc_html(smt_t('Turn an estimate into a verified savings plan.','حوّل التقدير إلى خطة توفير موثقة.')); ?></h2></div><p><?php echo esc_html(smt_t('Source More Technology can validate the opportunity through a structured fleet assessment covering volumes, utilization, contracts, workflow, security, and support requirements.','يمكن لـ Source More Technology التحقق من فرصة التوفير من خلال تقييم منظم يشمل الأحجام والاستخدام والعقود وسير العمل والأمان ومتطلبات الدعم.')); ?></p></div>
