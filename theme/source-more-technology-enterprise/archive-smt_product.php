...
<section class="ui-page-hero product-center-hero"><div class="container"><h1><?php echo esc_html(smt_t('Product Center','مركز المنتجات')); ?></h1><p><?php echo esc_html(smt_t('Explore business hardware, software, subscriptions, and integrated workplace technology available from Source More Technology.','اكتشف الأجهزة والبرمجيات والاشتراكات وحلول بيئة العمل المتكاملة التي توفرها سورس مور تكنولوجي.')); ?></p><div class="hero-actions"><a class="btn btn-gold" href="#product-grid"><?php echo esc_html(smt_t('Browse Products','تصفح المنتجات')); ?></a><a class="btn btn-outline" href="<?php echo esc_url(smt_page_url('contact')); ?>"><?php echo esc_html(smt_t('Request Sourcing Support','اطلب دعم التوريد')); ?></a></div></div></section>
